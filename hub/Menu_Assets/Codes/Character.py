...
class Player(pygame.sprite.Sprite):
    def __init__(self,pos,group,obstacles,regions):
        ...
        self.character=[
        [
            [[i,pygame.transform.scale(pygame.image.load(f"{Character_Selection_image_parent_path}/Blue_Units/Warrior/Warrior_Idle/row-1-column-{i}.png").convert_alpha(),(192,192))] for i in range(1,9)],
            [[i,pygame.transform.scale(pygame.image.load(f"{Character_Selection_image_parent_path}/Blue_Units/Warrior/Warrior_Run/row-1-column-{i}.png").convert_alpha(),(192,192))] for i in range(1,7)]
        ],
        [
            [[i,pygame.transform.scale(pygame.image.load(f"{Character_Selection_image_parent_path}/Red_Units/Warrior/Warrior_Idle/row-1-column-{i}.png").convert_alpha(),(192,192))] for i in range(1,9)],
